            ...
            {filtered.map((resource, i) => (
              ...
              >
                <div className="p-8 flex flex-col h-full">
                  ...
                  <h2 className="text-lg font-bold text-white mb-3 group-hover:text-[#2563EB] transition-colors leading-snug">
                    {resource.title}
                  </h2>
                  ...
                  {resource.url && (
                    <a
                      ...
                      className="text-[#2563EB] text-sm font-medium mt-4 inline-flex items-center gap-1 hover:underline"
                    >
                      Read more &rarr;
                    </a>
                  )}
